...
class ComputeLoss:
    ...
    # Compute losses
    def __init__(self, model, hyper_parameters: dict, autobalance=False):
        device = next(model.parameters()).device  # get model device
        # h = model.hyp  # hyperparameters
        hyp = {
            "box": hyper_parameters["box"],  # box loss gain,
            "cls": hyper_parameters["cls"],  # cls loss gain,
            # cls BCELoss positive_weight
            "cls_pw": hyper_parameters["cls_pw"],
            # obj loss gain (scale with pixels)
            "obj": hyper_parameters["obj"],
            # obj BCELoss positive_weight
            "obj_pw": hyper_parameters["obj_pw"],
            "iou_t": hyper_parameters["iou_t"],  # IoU training threshold
            # anchor-multiple threshold
            "anchor_t": hyper_parameters["anchor_t"],
            # focal loss gamma (efficientDet default gamma=1.5)"
            "fl_gamma": hyper_parameters["fl_gamma"],
        }
